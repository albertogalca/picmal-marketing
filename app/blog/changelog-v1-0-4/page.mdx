...
<FeatureCard title="Metadata Removal Option" icon="✓">
Protect your privacy by removing EXIF data, ICC profiles, GPS coordinates, and other metadata from your images during conversion.
</FeatureCard>

<FeatureCard title="Improved Window Resizing" icon="✓">
Better handling of window resizing with smoother animations and more responsive layout adjustments.
</FeatureCard>

<FeatureCard title="AVIF Corruption Fix" icon="🔧">
Fixed a critical issue where AVIF images could become corrupted during batch conversion processes.
</FeatureCard>
...
<ProTip>
When sharing images online or with clients, consider removing metadata to protect sensitive information. Picmal's metadata removal happens locally on your Mac—your images never leave your device.
</ProTip>