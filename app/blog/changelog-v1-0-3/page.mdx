...
export const meta = {
  ...
  description: 'Improved conversion speeds, added SVG support, and enhanced batch processing performance.',
  date: 'July 12, 2025',
  category: 'Changelog',
  readTime: '2 min read'
};
...
<FeatureCard title="SVG Format Support" icon="✓">
Convert vector graphics to raster formats while maintaining crisp quality. Perfect for converting icons and illustrations to PNG or JPEG.
</FeatureCard>

<FeatureCard title="40% Faster Conversions" icon="⚡">
Optimized conversion engine delivers significantly faster processing times, especially noticeable with large batches and high-resolution images.
</FeatureCard>

<FeatureCard title="Memory Usage Improvements" icon="🔧">
Reduced memory footprint by 30% when processing large images, allowing for smoother operation on older Mac models.
</FeatureCard>
...
<ProTip>
When converting SVG files, you can specify custom output dimensions to ensure your converted images are exactly the size you need. This is perfect for creating different icon sizes from a single SVG source.
</ProTip>