...
| Picmal | Yes | 0 to 100 | Yes, plus size cap | No | $39 |
...
- **Converting a whole library, not just RAW?** [How to batch convert images on Mac](/blog/batch-convert-images-mac) handles hundreds of mixed files in one pass.
