...
<!-- VERIFY: exact ColorSync Utility control labels on macOS 27. Confirmed as "Image Sampling" / "Image Compression" with Scale, Max and Quality in third-party writeups; Apple's own doc only covers applying a filter, not duplicating one. Worth one look in the app. -->
...
<!-- VERIFY: the print-to-PDF-makes-it-bigger claim is widely reported but I could not find a clean authoritative source. Soften or cut if you would rather not assert it. -->
