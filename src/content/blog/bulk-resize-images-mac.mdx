...
For a specific file size rather than a specific width, and for anything involving more than one image, keep reading.
...
Roughly proportional to the pixel reduction. Halving the width and height (e.g., 4000x3000 > 2000x1500) reduces pixel count by 75%, and file size drops similarly. A 4000px wide JPEG at 8MB becomes 1600px wide at about 1.2MB is typical.
