...
## Method 1: Preview (free, already on your Mac)
...
## Method 2: Terminal with sips (power users)
...
## Method 3: Online converters (if you don't mind uploading)
...
## Method 4: Picmal (fastest for batch)
...
Drag the entire folder into [Picmal](https://picmal.app) and select JPG. It converts everything and preserves the folder structure. Alternatively, use the `sips` for-loop in Terminal (Method 2 above), which costs nothing.
