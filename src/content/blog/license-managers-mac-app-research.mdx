...
A few months ago I chose Lemon Squeezy for <a href="https://picmal.app" target="_blank">Picmal</a> because it handled payments, licences, and affiliates in one dashboard.
...
I talked to the founder directly. Similar model to Lemon Squeezy, cheaper fees, and the checkout actually works. If I were starting fresh with direct sales only, I'd pick this over Lemon Squeezy without hesitating.
...
Nobody solves the reseller case in one place yet. For direct sales, Creem is a clear upgrade over Lemon Squeezy. For standalone licences, LicenseSeat is your only real option. And Amore is the one I'm watching for a future where distribution, updates, and licensing live in the same tool.
