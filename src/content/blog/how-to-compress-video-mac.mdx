...
faqs:
  - question: "How do I compress a video on my Mac for free?"
    answer: "QuickTime and iMovie are built in and can shrink a video by exporting at a lower resolution. HandBrake and FFmpeg are free downloads with real quality control. For batch jobs and a live size estimate, Picmal ($29, one-time) is faster."
...
- One-time $29, not a subscription
...
| Picmal    | Very Fast | Excellent | Live estimate | Very Easy  | $29 |
...
- **Only want the sound?** [How to extract audio from a video on Mac](/blog/how-to-extract-audio-from-video-mac) pulls the track out as MP3, M4A or WAV.
