...
description: "Five practical ways to reduce image file sizes on your Mac: resize, compress, convert to a modern format, or strip metadata. With actual before and after numbers."
pubDate: "2026-03-05"
category: "Tutorial"
...
Whether you call it compressing an image, shrinking a photo, or reducing file size, the fix comes down to four levers. Most guides bury them in 2,000 words of preamble, so here they are up front:
...
- **Optimizing images for a website specifically?** See [the best way to compress images for a website on Mac](/blog/compress-images-for-website-mac) for the PageSpeed-focused workflow.
- **Not sure which format to pick?** [The best image formats for the web](/blog/best-image-formats-for-web) compares JPEG, WebP, AVIF, and more.
- **Switching to a modern format?** [How to convert images to WebP on Mac](/blog/convert-images-to-webp-mac) walks through the full process.
- **Photos filling your disk?** [How to reduce photo library size on Mac](/blog/reduce-photo-library-size-mac) covers duplicates, screenshots, and iCloud offloading.
- **Coming from an iPhone?** [How to convert HEIC to JPG on Mac](/blog/how-to-convert-heic-to-jpg-mac) handles Apple's photo format, and the [HEIC converter for Mac](/heic-converter-mac) page covers the app side.
