---
title: "4 Free Ways to Open and Convert Sony ARW Files on a Mac"
heroImage: "../../../public/images/blog/convert-arw-to-jpg-mac/cover.png"
description: "Preview, Finder's Quick Action, the sips Terminal command and Photos all handle Sony ARW files on a Mac with nothing extra installed. What each one does well, what it gets wrong, and when a batch tool earns its place."
pubDate: "2026-08-18"
...
**Quick answer:** Preview > **File > Export** > Format **JPEG**. For a folder, `sips -s format jpeg -s formatOptions 90 photo.ARW --out photo.jpg` in Terminal. Both ship with macOS and neither uploads anything. If you just want the conversion and not the tutorial, [ARW to JPG](/convert/arw-to-jpg) is the one-page version.
...
- **Want the format details, not the methods?** [ARW to JPG](/convert/arw-to-jpg) covers what Picmal reads and writes for Sony files.
