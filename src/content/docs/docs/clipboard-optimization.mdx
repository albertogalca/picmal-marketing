...
description: Picmal automatically compresses any image you copy to your Mac's clipboard, so you paste a lighter version every time.
---
...
By default, you need to hover the overlay and click **Copy** to replace your clipboard with the compressed image. With **auto-copy** enabled, Picmal automatically copies the optimized image back to your clipboard as soon as compression finishes, no click needed.
...
- A valid Picmal license, or the [7-day trial](/docs/license#try-it-free)
