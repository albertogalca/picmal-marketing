---
title: PDF tools
description: Combine PDFs into one, split a PDF by page range, and turn images into multi-page PDFs — locally, with reorderable pages, page sizes, and optional password protection.
---

Picmal's sidebar has a **PDF** section with three tools: **Combine PDFs** merges documents into one, **Split PDF** breaks one document into several, and **Images to PDF** turns a set of images into a multi-page PDF. All run entirely on your Mac, like everything else in Picmal.
