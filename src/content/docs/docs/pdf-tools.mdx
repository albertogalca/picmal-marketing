...
- In Shortcuts, the **Combine PDFs**, **Split PDF**, and **Make PDF from Images** actions take files in and return the finished PDF. See [Integrations](/docs/integrations#shortcuts-app).
- From the terminal, use `picmal-cli combine`, `picmal-cli split-pdf`, and `picmal-cli images-to-pdf`. See [Command line](/docs/cli#split-pdf).
