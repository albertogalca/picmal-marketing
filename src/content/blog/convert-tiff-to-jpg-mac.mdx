...
Picmal preserves folder structure and handles multi-page TIFFs by extracting the first page. If you need to resize at the same time (TIFFs from scanners are often 600dpi at massive pixel dimensions), you can set a max width during conversion. If the same shoot also left you a card of camera RAW files, the [RAW converter for Mac](/raw-converter-mac) page covers ARW, CR2, NEF and DNG the same way.
