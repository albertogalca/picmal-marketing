...
heroImage: "../../../public/images/blog/convert-heic-to-png-mac/cover.png"
...
## Method 1: Preview (free, one at a time)
...
## Method 3: Quick Actions in Finder
...
## Method 4: Picmal (batch conversion)
...
Folder structure is preserved. Metadata can be stripped if you want. Everything stays on your Mac. If JPG is what you actually need rather than PNG, the [HEIC converter for Mac](/heic-converter-mac) page covers that side of it, and [how to batch convert HEIC photos on Mac](/blog/batch-convert-images-mac) handles a whole camera roll.
