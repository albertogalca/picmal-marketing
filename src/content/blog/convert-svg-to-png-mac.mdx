---
title: "Convert SVG to PNG on Mac: 4 Free Ways, No Upload"
heroImage: "../../../public/images/blog/convert-svg-to-png-mac/cover.png"
description: "Four free offline ways to turn SVG into PNG on your Mac: Preview, the qlmanage Terminal command, your browser, and rsvg-convert. Plus batching a folder."
pubDate: "2026-03-16"
...
faqs:
  ...
  - question: "Can I convert SVG to PNG on a Mac without installing anything?"
  ...
  - question: "How do I save an SVG as a PNG?"
    answer: "Saving and exporting are the same thing here. Preview just labels the command Export. Open the SVG in Preview, choose File > Export, set Format to PNG, pick a folder and save. Preview has no Save As option that changes the format, so Export is the one you want."
  - question: "How do I convert a PNG back to an SVG on a Mac?"
    answer: "That's vectorizing, not a format swap. A PNG is pixels and an SVG is shapes, so something has to trace the pixels and guess at the shapes. It works well on flat logos and line art, and badly on photos. Picmal has a Vectorize tool for it."
---
...
That's a different job, called vectorizing, and it isn't a format swap. A PNG is pixels. An SVG is shapes. So something has to trace the pixels and guess at the shapes underneath. It works well on flat logos and line art, and badly on photos. Picmal has a [Vectorize tool](/docs/vectorize) for it.
...
- **Converting more than SVGs?** [The batch image converters for Mac, compared](/blog/top-batch-image-converter-mac) covers the apps that handle mixed folders.
