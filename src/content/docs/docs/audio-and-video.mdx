...
Pick **ALAC** as the output format to get a lossless `.m4a` from FLAC, WAV, or AIFF — the format Apple Music expects for lossless libraries. ALAC conversions are bit-for-bit lossless; they preserve every sample of the source.
