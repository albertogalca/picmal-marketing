...
faqs:
  - question: "How do I convert audio to MP3 on a Mac for free?"
    answer: "The built-in Music app can do it: set the import encoder to MP3 in its settings, then select a track and choose File, Convert, Create MP3 Version. VLC and FFmpeg are free too. For batches and formats the Music app won't touch, Picmal ($19, one-time) is faster."
...
| --------- | --------- | --------- | -------------- | ----------- | ------ |
| Picmal    | Very Fast | Excellent | All, incl FLAC | Very Easy   | $19 |
